...
public class PasAPas extends ShortestPathAlgorithm {
    ...
    public PasAPas(ShortestPathData data) {
        super(data);
        mode = data.getMode();
    ...
    protected void importStations(){
        ...
        try {
            ...
            while ((station = reader.readLine()) != null) {
                ...
                notifyStation(node);//Notifiaction ici comme cela on montre que les atteignable
