    ...
    public class Path {
        ...
        public static Path createFastestPathFromNodes(Graph graph, List<Node> nodes)
            ...
            for(int i = 0; i <nodes.size()-1; i++) {
                ...
                for (Arc arc : nodes.get(i).getSuccessors()){
                    if(arc.getDestination()==nodes.get(i+1) && arc.getMinimumTravelTime()<shortest){
        ...
        public double getTravelTime(double speed) {
            double sum = 0;
            for(Arc arc : this.arcs) sum += arc.getTravelTime(speed);
            return sum;
        }
        ...
        public double getMinimumTravelTime() {
            double sum = 0;
            for(Arc arc : this.arcs) sum += arc.getMinimumTravelTime();
            return sum;
        }
